...
export const metadata = {
  title: "Twister — Straight Drive",
  description:
    "Dedicated swing and spin bowling machine — outswing, inswing, off-spin and leg-spin on demand.",
};

export default function Twister() {
  redirect("/performance-training");
  const content = productContent["twister"];
  const catalogItem = getByKey("twister");
    ...
    <>
     <div className="px-6 pt-6">
      ...
      <section className="bg-navy border-t border-cyan/[0.16] mt-10">
        ...
        <BookDemoBand />
      <YouMightLike currentKey="twister" />
    </>
  );
}