// src/app/performance-training/page.js
...
export const metadata = {
  title: "Performance Training — Straight Drive",
  description: "Cricket bowling machines and machine balls, engineered and built by Straight Drive.",
};

export default function PerformanceTraining() {
  const items = catalog.filter((p) => p.category === "performance-training");
