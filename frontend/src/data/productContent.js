    ...
    features: [
      {
        ...
        chips: ["Every ball stored", "Session history", "Bluetooth control"],
      },
      {
      ...
      },
      {
        ...
        photo: "/images/paceattack/touch-screen.jpg",
          ...
          desc: "A first-of-its-kind TFT touchscreen on a cricket bowling machine, bringing a modern, intuitive interface to control pace, swing and feed. Control pace, swing and feed directly from the machine, with the app available for advanced controls and smart features.",
        chips: ["TFT display", "On-machine control"],
      },
      {
        img: "Photo — tilt and pan mechanism close-up",
        photo: "/images/paceattack/tilt.jpg",
        title: "Precise gear-operated tilt & pan.",
        desc: "Precise gear-operated tilt & pan — smooth, accurate line and length adjustment with a robust geared movement system.",
      ...
      },
      {
        img: "Photo — hard PU balls and leather ball",
          title: "Hard PU & leather ball compatible.",
          desc: "Hard PU & leather ball compatible - designed to bowl hard PU balls while also supporting leather balls for realistic training.",
